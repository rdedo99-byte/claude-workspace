_v1.6 | updated by: family references genericized (no preset family; isaac_lab kept only as detection example) | 2026-07-01_

# Edoardo — Global Developer Profile

## Technical identity
- UniBS student + robotics intern @ Alto Robotics
- Recurring projects: Isaac Lab (RL), ROS2/Nav2, CAN bus, STM32, Valkyrie AMR
- OS: Ubuntu 22.04 | GPU: RTX 5080 Laptop | ROS2 Humble
- Isaac Lab installed in: /home/edoardo/IsaacLab/
...
| Hardware interface   | CAN bus, CANopen, STM32F446RE, FreeRTOS         |
| Robot platform       | Valkyrie AMR, 4-wheel swerve drive              |
...
4. Conclude with: "✅ agents family [name] updated — [N] agents, [N] checks added/removed"
